...
def test_tweet_quoted_tweet_single_user_reply_with_mentions_and_text(test_status):
    """Verify Tweet() processes quoted tweet that replies to group of mentions"""
...
def test_tweet_quoted_tweet_multiple_user_reply_with_image_and_text(test_status):
    """Verify Tweet() processes quoted tweet that replies to group of mentions"""
    test_tweet = test_status("quoted_multiple_user_reply_with_image_and_text")


def test_tweet_quoted_tweet_multiple_user_reply_with_image_and_no_text(test_status):
    """Verify Tweet() processes quoted tweet that replies to group of mentions"""
